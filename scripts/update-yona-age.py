#!/usr/bin/env python3
"""
Calculate Yona's age in quarters since birth date and update the JSON file.
"""
import json
import sys
...
JSON_FILE = Path(__file__).parent.parent / "data" / "yona-age.json"
...
def main():
    ...
    print(f"Updated Yona's age to: {age_str} years")
